...
/** Script identity by type and payload. Same field layout as `WsSubScript`. */
...
export interface BroadcastTxRequest {
     ...
     */
    finalizationTimeoutSecs: bigint;
}
...
function createBaseBlockInfo(): BlockInfo {
    return {
        ...
        numOutputs: 0n,
        sumInputSats: 0n,
        sumCoinbaseOutputSats: 0n,
        sumNormalOutputSats: 0n,
        sumBurnedSats: 0n,
    };
}
...
export const BlockInfo = {
    encode(
        ...
        if (message.sumCoinbaseOutputSats !== 0n) {
            if (
        ...
        if (message.sumNormalOutputSats !== 0n) {
            if (
    ...
    fromJSON(object: any): BlockInfo {
        return {
            ...
            numInputs: isSet(object.numInputs) ? BigInt(object.numInputs) : 0n,
    ...
    fromPartial<I extends Exact<DeepPartial<BlockInfo>, I>>(
        ...
        message.numInputs = object.numInputs ?? 0n;
        message.numOutputs = object.numOutputs ?? 0n;
        message.sumInputSats = object.sumInputSats ?? 0n;
        message.sumCoinbaseOutputSats = object.sumCoinbaseOutputSats ?? 0n;
        message.sumNormalOutputSats = object.sumNormalOutputSats ?? 0n;
        message.sumBurnedSats = object.sumBurnedSats ?? 0n;
        return message;
    },
};
    ...
    fromPartial<I extends Exact<DeepPartial<Tx>, I>>(object: I): Tx {
        ...
        message.block =
            object.block !== undefined && object.block !== null
                ...
                : undefined;
        message.timeFirstSeen = object.timeFirstSeen ?? 0n;
    ...
    fromJSON(object: any): ScriptUtxo {
        return {
            ...
            isCoinbase: isSet(object.isCoinbase)
                ? globalThis.Boolean(object.isCoinbase)
                : false,
            sats: isSet(object.sats) ? BigInt(object.sats) : 0n,
            isFinal: isSet(object.isFinal)
                ? globalThis.Boolean(object.isFinal)
                : false,
...
export const TokenEntry = {
    encode(
        ...
        if (message.intentionalBurnAtoms !== 0n) {
            if (
        ...
        if (message.burnsMintBatons !== false) {
    ...
    fromPartial<I extends Exact<DeepPartial<TokenEntry>, I>>(
        ...
        message.intentionalBurnAtoms = object.intentionalBurnAtoms ?? 0n;
    ...
    fromJSON(object: any): Token {
        return {
            ...
            entryIdx: isSet(object.entryIdx)
                ...
                : 0,
            atoms: isSet(object.atoms) ? BigInt(object.atoms) : 0n,
...
function createBaseScriptRef(): ScriptRef {
...
export const ScriptRef = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ScriptRef {
        const reader =
            input instanceof _m0.Reader ? input : _m0.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseScriptRef();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    toJSON(message: ScriptRef): unknown {
        const obj: any = {};
        if (message.scriptType !== '') {
    ...
    create<I extends Exact<DeepPartial<ScriptRef>, I>>(base?: I): ScriptRef {
        return ScriptRef.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<ScriptRef>, I>>(
        object: I,
    ): ScriptRef {
        const message = createBaseScriptRef();
...
function createBaseScriptBatchUtxosParams(): ScriptBatchUtxosParams {
    return { scripts: [] };
}

export const ScriptBatchUtxosParams = {
    encode(
        message: ScriptBatchUtxosParams,
        writer: _m0.Writer = _m0.Writer.create(),
    ): _m0.Writer {
    ...
    decode(
        input: _m0.Reader | Uint8Array,
        length?: number,
    ): ScriptBatchUtxosParams {
        const reader =
            input instanceof _m0.Reader ? input : _m0.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseScriptBatchUtxosParams();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object: any): ScriptBatchUtxosParams {
        return {
    ...
    toJSON(message: ScriptBatchUtxosParams): unknown {
        const obj: any = {};
    ...
    create<I extends Exact<DeepPartial<ScriptBatchUtxosParams>, I>>(
        base?: I,
    ): ScriptBatchUtxosParams {
        return ScriptBatchUtxosParams.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<ScriptBatchUtxosParams>, I>>(
        object: I,
    ): ScriptBatchUtxosParams {
        const message = createBaseScriptBatchUtxosParams();
        message.scripts =
...
function createBaseScriptBatchUtxosRequest(): ScriptBatchUtxosRequest {
    return { params: undefined };
}

export const ScriptBatchUtxosRequest = {
    encode(
        message: ScriptBatchUtxosRequest,
        writer: _m0.Writer = _m0.Writer.create(),
    ): _m0.Writer {
        if (message.params !== undefined) {
            ScriptBatchUtxosParams.encode(
                message.params,
                writer.uint32(10).fork(),
            ).ldelim();
        }
    ...
    decode(
        ...
        const reader =
            input instanceof _m0.Reader ? input : _m0.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseScriptBatchUtxosRequest();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.params = ScriptBatchUtxosParams.decode(
                        reader,
                        reader.uint32(),
                    );
                    continue;
    ...
    fromJSON(object: any): ScriptBatchUtxosRequest {
        return {
            params: isSet(object.params)
                ? ScriptBatchUtxosParams.fromJSON(object.params)
                : undefined,
        };
    },

    toJSON(message: ScriptBatchUtxosRequest): unknown {
        const obj: any = {};
        if (message.params !== undefined) {
            obj.params = ScriptBatchUtxosParams.toJSON(message.params);
        }
        return obj;
    },

    create<I extends Exact<DeepPartial<ScriptBatchUtxosRequest>, I>>(
        base?: I,
    ): ScriptBatchUtxosRequest {
        return ScriptBatchUtxosRequest.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<ScriptBatchUtxosRequest>, I>>(
        object: I,
    ): ScriptBatchUtxosRequest {
        const message = createBaseScriptBatchUtxosRequest();
        message.params =
            object.params !== undefined && object.params !== null
                ? ScriptBatchUtxosParams.fromPartial(object.params)
                : undefined;
        return message;
    },
};

function createBaseScriptBatchUtxosRow(): ScriptBatchUtxosRow {
    return { script: undefined, utxos: undefined };
}

export const ScriptBatchUtxosRow = {
    encode(
        message: ScriptBatchUtxosRow,
        writer: _m0.Writer = _m0.Writer.create(),
    ): _m0.Writer {
        if (message.script !== undefined) {
            ScriptRef.encode(message.script, writer.uint32(10).fork()).ldelim();
        }
        if (message.utxos !== undefined) {
            ScriptUtxos.encode(
                message.utxos,
                writer.uint32(18).fork(),
            ).ldelim();
    ...
    decode(
        ...
        const reader =
            input instanceof _m0.Reader ? input : _m0.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseScriptBatchUtxosRow();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                ...
                case 2:
                    ...
                    message.utxos = ScriptUtxos.decode(reader, reader.uint32());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object: any): ScriptBatchUtxosRow {
        return {
            script: isSet(object.script)
                ? ScriptRef.fromJSON(object.script)
                : undefined,
            utxos: isSet(object.utxos)
                ? ScriptUtxos.fromJSON(object.utxos)
                : undefined,
        };
    },

    toJSON(message: ScriptBatchUtxosRow): unknown {
        const obj: any = {};
        if (message.script !== undefined) {
            obj.script = ScriptRef.toJSON(message.script);
        }
        if (message.utxos !== undefined) {
            obj.utxos = ScriptUtxos.toJSON(message.utxos);
        }
        return obj;
    },

    create<I extends Exact<DeepPartial<ScriptBatchUtxosRow>, I>>(
        base?: I,
    ): ScriptBatchUtxosRow {
        return ScriptBatchUtxosRow.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<ScriptBatchUtxosRow>, I>>(
        object: I,
    ): ScriptBatchUtxosRow {
        const message = createBaseScriptBatchUtxosRow();
        message.script =
            object.script !== undefined && object.script !== null
                ...
                : undefined;
        message.utxos =
            object.utxos !== undefined && object.utxos !== null
                ? ScriptUtxos.fromPartial(object.utxos)
                : undefined;
        return message;
    },
};

function createBaseScriptBatchUtxosResponse(): ScriptBatchUtxosResponse {
    return { rows: [] };
}

export const ScriptBatchUtxosResponse = {
    encode(
        message: ScriptBatchUtxosResponse,
        writer: _m0.Writer = _m0.Writer.create(),
    ): _m0.Writer {
        for (const v of message.rows) {
            ScriptBatchUtxosRow.encode(v!, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.rows.push(
                        ScriptBatchUtxosRow.decode(reader, reader.uint32()),
                    );
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object: any): ScriptBatchUtxosResponse {
        return {
            rows: globalThis.Array.isArray(object?.rows)
                ? object.rows.map((e: any) => ScriptBatchUtxosRow.fromJSON(e))
                : [],
        };
    },

    toJSON(message: ScriptBatchUtxosResponse): unknown {
        const obj: any = {};
        if (message.rows?.length) {
            obj.rows = message.rows.map(e => ScriptBatchUtxosRow.toJSON(e));
        }
        return obj;
    },

    create<I extends Exact<DeepPartial<ScriptBatchUtxosResponse>, I>>(
        base?: I,
    ): ScriptBatchUtxosResponse {
        return ScriptBatchUtxosResponse.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<ScriptBatchUtxosResponse>, I>>(
        object: I,
    ): ScriptBatchUtxosResponse {
        const message = createBaseScriptBatchUtxosResponse();
        message.rows =
...
export const BroadcastTxRequest = {
    encode(
        ...
        if (message.skipTokenChecks !== false) {
            writer.uint32(16).bool(message.skipTokenChecks);
        }
        if (message.finalizationTimeoutSecs !== 0n) {
            if (
                BigInt.asUintN(64, message.finalizationTimeoutSecs) !==
                message.finalizationTimeoutSecs
            ) {
                throw new globalThis.Error(
                    'value provided for field message.finalizationTimeoutSecs of type uint64 too large',
                );
            }
            writer
                .uint32(24)
                .uint64(message.finalizationTimeoutSecs.toString());
        }
        return writer;
    },
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    message.finalizationTimeoutSecs = longToBigint(
                        reader.uint64() as Long,
                    );
                    continue;
            }
    ...
    fromJSON(object: any): BroadcastTxRequest {
        return {
            ...
            skipTokenChecks: isSet(object.skipTokenChecks)
                ...
                : false,
            finalizationTimeoutSecs: isSet(object.finalizationTimeoutSecs)
                ? BigInt(object.finalizationTimeoutSecs)
                : 0n,
        };
    },
    ...
    toJSON(message: BroadcastTxRequest): unknown {
        ...
        if (message.finalizationTimeoutSecs !== 0n) {
            obj.finalizationTimeoutSecs =
                message.finalizationTimeoutSecs.toString();
        }
        return obj;
    },
    ...
    fromPartial<I extends Exact<DeepPartial<BroadcastTxRequest>, I>>(
        ...
        message.finalizationTimeoutSecs = object.finalizationTimeoutSecs ?? 0n;
        return message;
    },
};
...
function createBaseBroadcastTxsRequest(): BroadcastTxsRequest {
    return { rawTxs: [], skipTokenChecks: false, finalizationTimeoutSecs: 0n };
}
